...
{
    /// <summary>
    /// Represents a Randon Number Generator, based on the XorShiftRandom for the Redzen library by Colin Green
    /// and realeased under the MIT license.
    /// 
    /// Copyright 2015 Colin D. Green (colin.green1@gmail.com)
    /// 
    /// Source code can be found at https://github.com/colgreen/sharpneat
    /// </summary>
    /// <seealso cref="Singular.Evolution.Utils.IRandomSource" />
    public class XorShiftRandomSource : IRandomSource
    {
        /// <summary>
        ...
        /// </summary>
        private static readonly XorShiftRandomSource __seedRng = new XorShiftRandomSource((int)Environment.TickCount);
