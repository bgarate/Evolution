...
namespace Evolution.Test
{
    ...
    public class IndividualTest
    {
        ...
        public void TestIndividualConstructors()
        {
            ...
            Individual<ListGenotype<FloatGene>, int> individual1 = new Individual<ListGenotype<FloatGene>, int>(genotype1);
            Individual<ListGenotype<FloatGene>, int> individual2 = new Individual<ListGenotype<FloatGene>, int>(genotype2,30);
